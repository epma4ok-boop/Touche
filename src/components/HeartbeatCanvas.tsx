...
export default function HeartbeatCanvas({
  ...
  useEffect(() => {
    ...
    const scaleRef = { value: baseRScale };
    ...
    const draw = (now: number) => {
      ...
      const baseR = Math.min(w, h) * scaleRef.value;
      const ringCount = 6;
      ...
      dotG.addColorStop(0, `rgba(${r},${g},${b},${0.55 + holdProgress * 0.38 + beatEnv * 0.12})`);
      dotG.addColorStop(0.6, `rgba(${r},${g},${b},${0.22 + holdProgress * 0.18})`);
