...
/**
 * Full-bleed animated background: deep ruby/black base with a slowly
 * rising, looping smoke texture (variant "A" — ruby + gold), used behind
 * every main screen instead of a flat color.
 */
export default function SmokeBackground({ dim = 0 }: { dim?: number }) {
  return (
    <div
      style={{
        position: "absolute",
        ...
        zIndex: 0,
        pointerEvents: "none",
        background: "radial-gradient(ellipse 120% 90% at 50% 30%, #250810 0%, #150408 55%, #0a0205 100%)",
      }}
    >
