        ...
        return (
          <button key={cat} onClick={()=>onDotPress(cat)} style={{background:"none",border:"none",padding:"8px 4px",cursor:"pointer",display:"flex",alignItems:"center"}}>
            <div style={{
              ...
              background:active?`rgb(${cfg.r},${cfg.g},${cfg.b})`:"rgba(40,30,50,.15)",
              boxShadow:active?`0 0 10px rgba(${cfg.r},${cfg.g},${cfg.b},.45)`:"none",
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        padding:"max(env(safe-area-inset-top),20px) 0 0",
        opacity:textVisible?1:0,
        transform:textVisible?"translateY(0)":"translateY(-8px)",
        transition:"opacity .5s ease .1s,transform .5s ease .1s",
      }}>
        <span style={{fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:400,fontSize:11,letterSpacing:"0.22em",textTransform:"uppercase",color:"rgba(255,255,255,.55)"}}>
          {catLabel}
        </span>
      </div>
      ...
      <div style={{
        ...
        transition:"opacity .6s cubic-bezier(.16,1,.3,1) .18s,transform .6s cubic-bezier(.16,1,.3,1) .18s",
        ...
        <p style={{
          ...
          textShadow:"0 2px 24px rgba(0,0,0,.15)",
        }}>{text}</p>
        {source==="ai" && (
...
export default function CategoryScreen({ lang,category,onBack,onCategoryChange,swipeDir }: Props) {
  ...
  const handleHoldComplete=useCallback(async()=>{
    ...
    // Run AI task generation + server limit deduction in parallel
  ...
  return (
    ...
    >
      {/* Top bar — with safe-area-inset-top */}
      <div style={{
        ...
        <div style={{textAlign:"center",flex:1}}>
          <p style={{fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:600,fontSize:19,color:"rgba(40,30,50,.85)",letterSpacing:"-0.01em",margin:0}}>
            {catLabels[category]}
          </p>
        </div>
      ...
      <div style={{textAlign:"center",flexShrink:0,position:"relative",zIndex:10,padding:"0 24px 2px"}}>
        <p style={{fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:300,fontSize:12,letterSpacing:"0.14em",textTransform:"uppercase",color:`rgba(${r},${g},${b},.55)`,margin:0}}>
          {catSubs[category]}
        </p>
      </div>
      ...
      {remaining>0 && (
        <div style={{textAlign:"center",flexShrink:0,position:"relative",zIndex:10,paddingTop:3}}>
          <span style={{fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:300,fontSize:11,letterSpacing:"0.10em",textTransform:"uppercase",color:`rgba(${r},${g},${b},.38)`}}>
            {t.remaining(remaining)}
          </span>
        </div>
      )}

      {/* HeartbeatCanvas — the original beautiful hold animation, circles ~30% bigger */}
      ...
      <div style={{flexShrink:0,position:"relative",zIndex:10,paddingBottom:6}}>
        ...
        <p style={{textAlign:"center",fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:400,fontSize:11,letterSpacing:"0.16em",textTransform:"uppercase",color:"rgba(40,30,50,.28)",margin:"6px 0 0"}}>
          {t.swipeHint}
        </p>
      </div>
      ...
      <div style={{display:"flex",justifyContent:"center",alignItems:"center",
        ...
        flexShrink:0,position:"relative",zIndex:10}}>
        {remaining===0 ? (
          <button onClick={()=>setStarsShopOpen(true)} style={{background:`rgba(${r},${g},${b},.07)`,border:`1px solid rgba(${r},${g},${b},.22)`,borderRadius:12,cursor:"pointer",fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:500,fontSize:12,letterSpacing:"0.10em",textTransform:"uppercase",color:`rgba(${r},${g},${b},.70)`,padding:"10px 18px"}}>
            {t.limitBtn}
          </button>
        ) : (
