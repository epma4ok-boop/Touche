...
/* ─────────── Atmospheric category header band ─────────── */
function CategoryHeader({ category, catLabel, catSub }: { category: Category; catLabel: string; catSub: string }) {
  ...
  /* Optional: if you place AI art images in /images/cat-{id}.png, they appear as background.
     The gradient overlay keeps text readable regardless. */
  ...
  return (
    <div style={{
      ...
      height: 72,
      overflow: "hidden",
      borderBottom: `0.5px solid rgba(${r},${g},${b},0.20)`,
    }}>
      ...
      {/* CSS atmosphere fallback / overlay */}
      <div style={{
        position: "absolute", inset: 0,
        background: `radial-gradient(ellipse at 80% 50%, rgba(${r},${g},${b},0.25) 0%, transparent 65%), radial-gradient(ellipse at 20% 50%, rgba(${r},${g},${b},0.12) 0%, transparent 60%)`,
      }} />

      {/* Dark gradient to keep left/bottom readable */}
      <div style={{
        position: "absolute", inset: 0,
        background: `linear-gradient(90deg, ${BG}cc 0%, ${BG}88 40%, transparent 100%)`,
      }} />

      {/* Top shimmer line */}
      <div style={{
        position: "absolute", top: 0, left: 0, right: 0, height: 1,
        background: `linear-gradient(90deg, transparent 0%, rgba(${r},${g},${b},0.55) 50%, transparent 100%)`,
      }} />
...
export default function CategoryScreen({ lang, category, onBack, onCategoryChange, swipeDir }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* Atmospheric header band — shows category name, sub, and art */}
