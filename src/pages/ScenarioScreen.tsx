...
export default function ScenarioScreen({ lang, onBack }: ScenarioScreenProps) {
  ...
  const handleInvite = useCallback(() => {
    ...
    if (tg?.openTelegramLink && userId) {
      tg.openTelegramLink(`https://t.me/share/url?url=https://t.me/ToucheBot?start=ref_${userId}&text=${encodeURIComponent(lang==="en"?"Join me on Touché — evening scenarios for couples":"Присоединяйся ко мне в Touché — сценарии для пар на вечер")}`);
    }
  }, [lang]);
